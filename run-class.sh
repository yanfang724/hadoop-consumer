...
for file in $base_dir/contrib/hadoop-consumer-test/lib_managed/scala_2.8.0/compile/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done
...
for file in $base_dir/contrib/hadoop-consumer-test/target/scala_2.8.0/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done

for file in $base_dir/contrib/hadoop-consumer-test/lib/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done
